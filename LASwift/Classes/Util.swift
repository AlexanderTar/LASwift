...
func matrixOperation(_ op: MatrixMatrixOperation, _ A: Matrix, _ B: Matrix) -> Matrix {
...
func scalarOperation(_ op: MatrixScalarOperation, _ A: Matrix, _ b: Double) -> Matrix {
    return Matrix(A.rows, A.cols, op(A.flat, b))
}

typealias InvMatrixScalarOperation = ((_ a: Double, _ B: Vector) -> Vector)

func invScalarOperation(_ op: InvMatrixScalarOperation, _ a: Double, _ B: Matrix) -> Matrix {
